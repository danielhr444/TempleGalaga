...
public class Stage3 extends JPanel implements ActionListener, KeyListener {
    /**
     *
     */
   ...
   JFrame frame;
    ...
    public static void main(String[] args) throws Exception {
        Stage3 d = new Stage3(); //TODO: add in main frame
    }
    */
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = Stage3.class.getResource(path);
	...
	public void drawWinStage(Graphics g) {
		...
		g.drawString("Nice, you outran the storm!", Main.width/2 - 250 , Main.height/2 - 50);

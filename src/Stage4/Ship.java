...
public class Ship {
    ...
    public void updateShip() {
       ...
       if (x < Main.width-sideLength && x > 0 && y < Main.height - sideLength && y > 0 && GamePanel.GAME_STAGE != 2) {	
    	   startX += vx;
    	   startY += vy;
       }  if (x > Main.width-sideLength && GamePanel.GAME_STAGE != 2) {
    	  startX -= 5;
       }  if (x < 0 && GamePanel.GAME_STAGE != 2) {
    	   startX += 5;
       }  if (y < 0 && GamePanel.GAME_STAGE != 2) {
    	   startY += 5;
       }  if (y > Main.height - sideLength*3 && GamePanel.GAME_STAGE != 2) {
    	   startY -= 5;
       }
